...
function About() {
  return (
    ...
    <section className="w-full max-w-[860px] m-auto px-4 sm:px-6 lg:px-0">
      <img className='mb-14 w-full lg:w-auto' src={Abanner} alt="" />
      <h1 className='text-[35px] uppercase grid text-center text-gray-600 mb-4'>welcome to demo</h1>
      <p className='text-xs font-normal text-gray-600 w-full lg:w-155 grid text-center m-auto mb-12'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. U enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dol in reprehenderit in</p>
    </section>
    <section className='w-full max-w-[800px] m-auto px-4 sm:px-6 lg:px-0'>
      <div className='grid grid-cols-1 sm:grid-cols-3 mb-18'>
      <div>
    ...
    <section className=' m-auto'>
      <p className='text-sm leading-[1.625] text-gray-600 w-full lg:w-165 grid text-center m-auto pb-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. U enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dol in reprehenderit in .</p>
    ...
    <section>
      ...
      <div className="relative after:content-none md:after:content-[''] after:absolute after:bottom-0 after:left-160 after:w-[90px] after:h-[1px] after:bg-gray-400">
 </div>



  <section className="w-full max-w-[860px] mx-auto px-4 sm:px-6 lg:px-0 py-20">
